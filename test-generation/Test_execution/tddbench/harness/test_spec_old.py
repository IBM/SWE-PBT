...
#     cmd = f"python -m pip install hypothesis pytest"
#     reqs_commands.append(cmd)
...
#     test_command = "cd /testbed/pbt && IS_REGRESSION=$IS_REGRESSION pytest --hypothesis-log-all test.py -vs"
...
#         "source /opt/miniconda3/bin/activate",
#         f"conda activate {env_name}",
#         # hypothesis and pytest are now installed during environment setup, no need to install here
