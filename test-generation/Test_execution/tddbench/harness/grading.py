...
import tddbench.harness.log_parsers as log_parsers
...
def get_logs_eval(log_fp: str, log_parser_name: str | None = None) -> tuple[dict[str, str], bool]:
    """
    ...
    """
    if log_parser_name is not None:
        log_parser = getattr(log_parsers, log_parser_name)
    else:
        ...
        log_parser = MAP_REPO_TO_PARSER.get(repo, log_parsers.parse_log_pytest)
